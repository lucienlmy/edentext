...
export const CANDIDATE_FONTS: readonly string[] = [
  ...
  'Meiryo', 'Meiryo UI', 'MS Gothic', 'MS Mincho', 'MS PGothic', 'MS PMincho', 'MV Boli',
  ...
  'Yu Gothic', 'Yu Gothic UI', 'Yu Mincho', 'BIZ UDGothic', 'BIZ UDMincho',
  ...
  'Hiragino Kaku Gothic ProN', 'Hiragino Mincho ProN', 'Hiragino Sans', 'Hiragino Sans GB',
